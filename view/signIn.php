...
$databaseConnection->insertUserData();
...
<body class="menu-collapsed">
							...
							<div class="form-block">
								<form class="form-common" action="" method="post">
									<div class="form-group row">
										<div class="col-md-12">
											<input type="text" class="form-control" name="userName" id="inputUserNamel3" placeholder="UserName">
										</div>
									</div>
									<div class="form-group row">
										<div class="col-md-12">
									...
									<div class="form-group row">
                                        <div class="offset-2">
                                        <input type="submit" class="btn btn-raised btn-primary waves-effect waves-light" value="Login" name="login">
										<input type="reset" class="btn btn-raised btn-primary waves-effect waves-light" value="Cancel" name="cancel">
    ...
    <input type="submit" style="width:100%;background-color: #4285F4;    border: none;
    color: white;padding: 1%;"  value="cancel" name="cancel"> -->
										</div>
									</div>
								</form>
							</div>
